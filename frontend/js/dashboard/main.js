 ...
 * (Aunque el dashboard no tiene sidebar, se mantiene por si se reutiliza el script).
 */
function marcarSidebarActivo() {
    let ruta = window.location.pathname.split('/').pop();
    if (!ruta || ruta === 'panelControl.html') ruta = 'panelControl.html';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Solo se ejecuta la lógica global y de fondo interactivo
    marcarSidebarActivo();
