// Función para cerrar sesión
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Lógica del Tipo de Cambio Real (Conector Robusto MUROTECH) ---
            async function actualizarTipoCambio() {
                ...
                if (data) {
                    ...
                    if (labelStatus && labelStatus.querySelector('span')) {
                        ...
                        labelStatus.querySelector('i').className = 'fas fa-check-circle';
                    }
                    ...
                    labelStatus.querySelector('i').className = 'fas fa-exclamation-triangle';
                }
            }
