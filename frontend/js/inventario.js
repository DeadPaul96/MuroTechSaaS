            ...
            Swal.fire({
                ...
                html: `
                    <div style="display:flex; flex-direction:column; gap:12px; margin-top: 15px; text-align:left;">
                        ...
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                            <div>
                                <label style="font-size:0.7rem; font-weight:800; color:#475569; margin-left:12px; display:block; margin-bottom:4px;">Tipo Impuesto (Normativa 4.4)</label>
                                <select id="swal-tipo-impuesto" class="premium-select" style="width:100%; background:#fff; border:1.5px solid #cbd5e1; color:#0f172a; cursor:pointer;">
                            ...
                            <div>
                                <label style="font-size:0.7rem; font-weight:800; color:#475569; margin-left:12px; display:block; margin-bottom:4px;">Tarifa (%) [Editable en Inventario]</label>
                                <select id="swal-iva" class="premium-select" style="width:100%; background:#fff; border:1.5px solid #cbd5e1; color:#0f172a; cursor:pointer;">
